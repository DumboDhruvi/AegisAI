...
| --- | --------------------------- | ----------- | ---------------- | ----------------------------------------------- |
| —   | Project Scaffolding & Setup | IN PROGRESS | Foundation       | Git, venv, pyproject.toml, architecture layout |
| M1  | Evaluation Dataset          | TODO        | Milestone 1      | Schemas, validation, loader, tags, rejection    |
